import { getHotelRatings } from "@/database/queries/hotels";

const HotelRatingNumber = async ({ id }) => {
    let ratings = await getHotelRatings(id);
...
export default HotelRatingNumber;
